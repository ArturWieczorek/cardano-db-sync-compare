...
If a table's two fingerprints don't match, "table X differs" isn't very useful on
its own. The tool then **localizes** the difference to a narrow stretch of chain,
by **binary search** — the "guess my number" game.
